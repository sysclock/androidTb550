package com.example.tbc.xxbluetooth;
...
public class  HolloMainActivity extends ListActivity
{
    ...
    private String TAG = "HolloMainActivity";
...
//                	}
    ...
    private class LeDeviceListAdapter extends BaseAdapter 
    {
        ...
        public LeDeviceListAdapter(Context context) 
        {
            ...
            mInflator = LayoutInflater.from(context);//HolloMainActivity.this.getLayoutInflater();
        }
