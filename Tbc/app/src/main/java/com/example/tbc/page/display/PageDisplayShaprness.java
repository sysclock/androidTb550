...
public class PageDisplayShaprness extends Activity implements RemoteCallRet {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_display_set_shaprness);
            ...
            public void onClick(View v)
            {
                ...
                if(value >= 0 && value <= 100) {
                   /* if (Bluetooth.write(TB3531.packEvent(
                            ...
                            TB3531.EVENT_DISPLAY_ID_SET_BRIGHTNESS,
                            (byte) (srcID & 0xff),
                            (byte) (value & 0xff)))) {
    ...
    public void onCallRet(Byte[] response) {
        ...
        if(ei != null && ei.EventGroupID == TB3531.EVENT_GROUP_ID_DISPLAY
                && ei.eventId == TB3531.EVENT_DISPLAY_ID_SET_BRIGHTNESS){
