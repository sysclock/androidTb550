...
public class PageLedGetResolution extends Activity implements RemoteCallRet {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_led_get_resolution);
        ...
        set.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Byte[] pack = TB3531.packEvent(
                        ...
                        TB3531.EVENT_LED_ID_GET_RESOLUTION,
                        evContent);
    ...
    void updateCoustomResolution(){
        ...
        w = (EditText)findViewById(R.id.editTextWidth);
    ...
    public void onCallRet(Byte[] response) {
        ...
        if(ei != null && ei.EventGroupID == TB3531.EVENT_GROUP_ID_LED
                && ei.eventId == TB3531.EVENT_LED_ID_GET_RESOLUTION){
