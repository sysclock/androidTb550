...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        BluetoothDataService.setDeviceInfo(device,device.getName(),device.getAddress());

        //Intent intent = new Intent("com.tbc.bluetooth.BluetoothDataService");

       // startService(intent);



        final Intent it = new Intent(DeviceScanActivity.this,BluetoothDataService.class);
        startService(it);
    }
