...
public class BluetoothLeService extends Service {
    ...
    public int WriteValue(byte[] bytes)
    {
        Log.e(TAG,"WriteValue len=" + bytes.length);
        mNotifyCharacteristic.setValue(bytes);
        boolean ret = mBluetoothGatt.writeCharacteristic(mNotifyCharacteristic);

        return ret?bytes.length:0;
    }
